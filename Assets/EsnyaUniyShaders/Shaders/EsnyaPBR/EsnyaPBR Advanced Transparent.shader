...
Shader "Esnya PBR/Advanced/Transparent"
{
	...
	SubShader
	{
		...
		void RefractionF( Input i, SurfaceOutputStandardCustom o, inout half4 color )
		{
			...
			float2 uv_MetallicGlossMap203_g13 = i.uv_texcoord;
			#ifdef _PACKEDMASK_ON
				float staticSwitch199_g13 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap203_g13 ).b;
			#else
				float staticSwitch199_g13 = tex2D( _ParallaxMap, uv_ParallaxMap119_g13 ).r;
			#endif
			float3 ase_worldPos = i.worldPos;
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float2 Offset118_g13 = ( ( staticSwitch199_g13 - 1 ) * ase_worldViewDir.xy * _Parallax ) + uv_MainTex;
			#ifdef _PARALLAXMAP
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float2 uv_MetallicGlossMap206_g13 = i.uv_texcoord;
			float lerpResult191_g13 = lerp( tex2D( _MetallicGlossMap, uv_MetallicGlossMap206_g13 ).a , tex2D( _MainTex, uv_MainTex ).a , _SmoothnessTextureChannel);
			#ifdef _PACKEDMASK_ON
				float staticSwitch207_g13 = lerpResult191_g13;
			#else
				float staticSwitch207_g13 = tex2D( _SpecGlossMap, staticSwitch127_g13 ).r;
			#endif
			#ifdef _METALLICGLOSSMAP
				float staticSwitch189_g13 = pow( ( lerpResult191_g13 * _Glossiness ) , _RoughnessSmoothnessCorrection );
			#else
				float staticSwitch189_g13 = ( 1.0 - pow( ( staticSwitch207_g13 * _Glossiness ) , _RoughnessSmoothnessCorrection ) );
			#endif
			float3 newWorldNormal3_g14 = (WorldNormalVector( i , staticSwitch181_g13 ));
			float3 temp_output_6_0_g14 = ddx( newWorldNormal3_g14 );
			float dotResult7_g14 = dot( temp_output_6_0_g14 , temp_output_6_0_g14 );
			float3 temp_output_10_0_g14 = ddy( newWorldNormal3_g14 );
			float dotResult12_g14 = dot( temp_output_10_0_g14 , temp_output_10_0_g14 );
			#ifdef _GeometricSpecularAA
				float staticSwitch187_g13 = ( 1.0 - pow( saturate( max( dotResult7_g14 , dotResult12_g14 ) ) , 0.333 ) );
			#else
				float staticSwitch187_g13 = 1.0;
			#endif
			o.Smoothness = min( staticSwitch189_g13 , staticSwitch187_g13 );
			float2 uv_MetallicGlossMap205_g13 = i.uv_texcoord;
			#ifdef _PACKEDMASK_ON
				float staticSwitch204_g13 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap205_g13 ).g;
			#else
				float staticSwitch204_g13 = tex2D( _OcclusionMap, staticSwitch127_g13 ).r;
			#endif
			o.Occlusion = ( staticSwitch204_g13 * _OcclusionStrength );
...
/*ASEBEGIN
Version=18909
0;1191;2276;889;1408.45;346.3253;1;True;True
Node;AmplifyShaderEditor.FunctionNode;14;-642.9976,-130.1833;Inherit;False;EsnyaPBR;0;;13;d7448cd6078718a4b92322da44cf5771;2,179,0,175,1;1;180;FLOAT2;0,0;False;11;FLOAT3;0;FLOAT3;34;FLOAT3;42;FLOAT;30;FLOAT;17;FLOAT;44;FLOAT3;89;FLOAT3;96;FLOAT;84;FLOAT;14;FLOAT3;115
Node;AmplifyShaderEditor.IntNode;4;-608,192;Inherit;False;Property;_CullMode;Cull Mode;47;2;[Header];[Enum];Create;False;1;Shader Options;0;1;CullMode;True;0;False;2;2;False;0;1;INT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-89,-125;Float;False;True;-1;2;EsnyaFactory.EsnyaPBRGUI;0;0;Standard;Esnya PBR/Advanced/Transparent;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;ForwardOnly;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;38;45;-1;0;False;0;0;True;4;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=A50CD6002AF5F2980E952F0CE2000EE3B5B4F9B2