...
Shader "Esnya PBR/Advanced/Cutout"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float2 uv_MetallicGlossMap203_g7 = i.uv_texcoord;
			#ifdef _PACKEDMASK_ON
				float staticSwitch199_g7 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap203_g7 ).b;
			#else
				float staticSwitch199_g7 = tex2D( _ParallaxMap, uv_ParallaxMap119_g7 ).r;
			#endif
			float3 ase_worldPos = i.worldPos;
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float2 Offset118_g7 = ( ( staticSwitch199_g7 - 1 ) * ase_worldViewDir.xy * _Parallax ) + uv_MainTex;
			#ifdef _PARALLAXMAP
			...
			float2 uv_MetallicGlossMap206_g7 = i.uv_texcoord;
			float lerpResult191_g7 = lerp( tex2D( _MetallicGlossMap, uv_MetallicGlossMap206_g7 ).a , tex2D( _MainTex, uv_MainTex ).a , _SmoothnessTextureChannel);
			#ifdef _PACKEDMASK_ON
				float staticSwitch207_g7 = lerpResult191_g7;
			#else
				float staticSwitch207_g7 = tex2D( _SpecGlossMap, staticSwitch127_g7 ).r;
			#endif
			#ifdef _METALLICGLOSSMAP
				float staticSwitch189_g7 = pow( ( lerpResult191_g7 * _Glossiness ) , _RoughnessSmoothnessCorrection );
			#else
				float staticSwitch189_g7 = ( 1.0 - pow( ( staticSwitch207_g7 * _Glossiness ) , _RoughnessSmoothnessCorrection ) );
			#endif
			...
			float2 uv_MetallicGlossMap205_g7 = i.uv_texcoord;
			#ifdef _PACKEDMASK_ON
				float staticSwitch204_g7 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap205_g7 ).g;
			#else
				float staticSwitch204_g7 = tex2D( _OcclusionMap, staticSwitch127_g7 ).r;
			#endif
			o.Occlusion = ( staticSwitch204_g7 * _OcclusionStrength );
...
/*ASEBEGIN
Version=18909
0;1191;2276;889;1354.741;455.1084;1;True;True
...
Node;AmplifyShaderEditor.IntNode;4;-512,160;Inherit;False;Property;_CullMode;Cull Mode;45;2;[Header];[Enum];Create;False;1;Shader Options;0;1;CullMode;True;0;False;2;0;False;0;1;INT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;0,-128;Float;False;True;-1;2;EsnyaFactory.EsnyaPBRGUI;0;0;Standard;Esnya PBR/Advanced/Cutout;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Masked;0.5;True;True;0;False;TransparentCutout;;AlphaTest;ForwardOnly;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;46;38;-1;-1;0;False;0;0;True;4;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=BD24BD2AB0376F18AC977C55FB27A6F82276ECEB