...
Shader "EsnyaUnityShaders/Normal Projection"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 normalizeResult40 = ASESafeNormalize( cross( ase_vertexNormal , worldToObjDir57 ) );
			float3 ase_vertex3Pos = mul( unity_WorldToObject, float4( i.worldPos , 1 ) );
			float dotResult43 = dot( normalizeResult40 , ase_vertex3Pos );
			float3 normalizeResult42 = ASESafeNormalize( cross( normalizeResult40 , ase_vertexNormal ) );
			float dotResult44 = dot( normalizeResult42 , ase_vertex3Pos );
			float2 appendResult26 = (float2(dotResult43 , dotResult44));
			float2 temp_output_54_0 = ( ( appendResult26 * _MainTex_ST.xy ) + _MainTex_ST.zw );
...
/*ASEBEGIN
Version=18935
0;1188;1267;891;1819.762;-147.0315;2.022533;True;False
...
Node;AmplifyShaderEditor.NormalVertexDataNode;58;-2208,64;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PosVertexDataNode;59;-2208,224;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-1457.585,130.006;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-1408,384;Inherit;False;Property;_Parallax;Height Scale;6;0;Create;False;0;0;0;False;0;False;0.05;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;3;-512,-128;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;2;-512,64;Inherit;True;Property;_MainTex;Albedo;1;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;10;-512,1024;Inherit;False;Property;_EmissionColor;Emission Color;9;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,1;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;15;-512,640;Inherit;True;Property;_SpecGlossMap;Roughness;7;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;2;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;7;-512,256;Inherit;True;Property;_BumpMap;Normal Map;2;2;[NoScaleOffset];[Normal];Create;False;0;0;0;False;0;False;2;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=524601698A5F028CAAC27EB15A35EF6EEB980D61